...
**Using [STARNET](https://github.com/Wainberg/Vulnerabilities_of_TWAS) and [BLUEPRINT](ftp://ftp.ebi.ac.uk/pub/databases/blueprint/blueprint Epivar/qtl_as/) as an example, for details, please see Results and Methods sections of manuscript**
