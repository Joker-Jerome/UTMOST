...
**3. Download reference data (cross-tissue imputation models and test data) [reference data](https://drive.google.com/uc?export=download&id=1u8CRwb6rZ-gSPl89qm3tKpJArUT8XrEe)**
```bash
